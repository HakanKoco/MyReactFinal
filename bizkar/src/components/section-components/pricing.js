...
class Pricing extends Component {
  ...
  render() {
    ...
    return (
      <section className="pricing-one" style={{ backgroundImage: 'url(' + publicUrl + 'assets/images/shapes/dotted-patter-2.png)' }}>
        <div className="container">
          <div className="pricing-one__block">
            <div className="block-title-two text-left">
              <p>Teklif Al</p>
              <h3>Bizimle İletişime Geçmekten <br /> Çekinmeyin, Geri Dönüş Alın</h3>
            </div>{/* /.block-title-two */}
