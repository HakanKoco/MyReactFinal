							...
							<div className="col-lg-5">
								<div className="contact-two__content">
									<div className="contact-two__block">
										<h3>Bize Ulaşmaktan Çekinmeyin</h3>
									...
									<ul className="list-unstyled contact-two__info-list">
										<li>
											...
											<p>27 Division St, New York, <br />NY 10002, ABD</p>
										</li>
										<li>
											<div className="contact-two__info-list-title">
							...
							<div className="col-lg-7">
								<form action="#" className="contact-two__form">
									...
									<div className="row">
										...
										<div className="col-md-12">
											<textarea name="message" placeholder="Mesaj" defaultValue={""} />
											<button type="submit" className="thm-btn contact-two__btn">Mesaj Gönder <i className="fa fa-angle-double-right" /></button>{/* /.thm-btn contact-two__btn */}
										</div>{/* /.col-md-12 */}
									</div>{/* /.row */}
