        ...
        <div className="container">
          <div className="pricing-one__block">
            <div className="block-title-two text-left">
              <p>Teklif Al</p>
              <h3>Harika <br /> Fiyatlandırma Planları Sunuyoruz</h3>
            </div>{/* /.block-title-two */}
            <div className="pricing-one__btn-block">
              <ul className="list-unstyled nav nav-tabs">
                <li className="nav-item">
                  <a href="#monthly2" className="nav-link active" data-toggle="tab">Aylık</a>
                </li>{/* /.nav-item */}
                <li className="nav-item">
                  <a href="#yearly2" className="nav-link " data-toggle="tab">Yıllık</a>
                </li>{/* /.nav-item */}
