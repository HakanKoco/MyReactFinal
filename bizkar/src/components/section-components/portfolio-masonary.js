      ...
      <div className="container">
        <div className="row masonary-layout">
          <div className="col-md-6 masonary-item">
            <div className="portfolio-two__single">
              ...
              <div className="portfolio-two__content">
                <h3><Link to="/portfolio-details">Yaratıcı İllüstrasyon</Link></h3>
                <p>ürün tasarımı</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 masonary-item">
            <div className="portfolio-two__single">
              <div className="portfolio-two__image">
                <img src={publicUrl + "assets/images/portfolio/portfolio-5-3.jpg"} alt={imagealt} />
              </div>{/* /.portfolio-two__image */}
              <div className="portfolio-two__content">
                <h3><Link to="/portfolio-details">Yaratıcı İllüstrasyon</Link></h3>
                <p>ürün tasarımı</p>
          ...
          <div className="col-md-6 masonary-item">
            <div className="portfolio-two__single">
              <div className="portfolio-two__image">
                <img src={publicUrl + "assets/images/portfolio/portfolio-5-4.jpg"} alt={imagealt} />
              </div>{/* /.portfolio-two__image */}
              <div className="portfolio-two__content">
                <h3><Link to="/portfolio-details">Yaratıcı İllüstrasyon</Link></h3>
                <p>ürün tasarımı</p>
          ...
          <div className="col-md-6 masonary-item">
            <div className="portfolio-two__single">
              <div className="portfolio-two__image">
                <img src={publicUrl + "assets/images/portfolio/portfolio-5-5.jpg"} alt={imagealt} />
              </div>{/* /.portfolio-two__image */}
              <div className="portfolio-two__content">
                <h3><Link to="/portfolio-details">Yaratıcı İllüstrasyon</Link></h3>
                <p>ürün tasarımı</p>
          ...
          <div className="col-md-6 masonary-item">
            <div className="portfolio-two__single">
              <div className="portfolio-two__image">
                <img src={publicUrl + "assets/images/portfolio/portfolio-5-6.jpg"} alt={imagealt} />
              </div>{/* /.portfolio-two__image */}
              <div className="portfolio-two__content">
                <h3><Link to="/portfolio-details">Yaratıcı İllüstrasyon</Link></h3>
                <p>ürün tasarımı</p>
        ...
        <div className="text-center">
          <Link to="/portfolio-full" className="portfolio-masonary__more-btn thm-btn">Daha Fazla Gör <i className="fa fa-angle-double-right" /></Link>
        </div>{/* /.text-center */}
      </div>{/* /.container */}
    </section>
