							...
							<div className="my-auto">
								<div className="service-two__block">
									<div className="block-title-two text-left">
										...
										<h3>İşiniz İçin <br />
											En İyi <br />
											Hizmetleri Sunuyoruz</h3>
									</div>{/* /.block-title-two */}
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
										labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
										laboris nisi ut aliquip ex ea commodo consequat. </p>
									<Link to="/service" className="thm-btn">Tüm Hizmetleri Gör <i className="fa fa-angle-double-right" /></Link>
									{/* /.thm-btn */}
									...
									<div className="col-md-6">
										<div className="service-two__single js-tilt">
											...
											<div className="service-two__single-inner">
												...
												<h3><Link to="/service-details">Finans &amp; Sigorta</Link></h3>
									...
									<div className="col-md-6">
										<div className="service-two__single js-tilt">
											...
											<div className="service-two__single-inner">
												...
												<h3><Link to="/service-details">Yatırım Planlaması</Link></h3>
												<p>Lorem ipsum dolor sit amet conse
													ctetur adipisicing elit sed do eiusmod tempor incididunt ut labore et</p>
												<Link to="/service-details" className="service-two__link"><i className="fa fa-long-arrow-alt-right" /></Link>
												{/* /.service-two__link */}
									...
									<div className="col-md-6">
										<div className="service-two__single js-tilt">
											...
											<div className="service-two__single-inner">
												...
												<h3><Link to="/service-details">Pazar Konumlandırma</Link></h3>
												<p>Lorem ipsum dolor sit amet conse
													ctetur adipisicing elit sed do eiusmod tempor incididunt ut labore et</p>
												<Link to="/service-details" className="service-two__link"><i className="fa fa-long-arrow-alt-right" /></Link>
												{/* /.service-two__link */}
									...
									<div className="col-md-6">
										<div className="service-two__single js-tilt">
											...
											<div className="service-two__single-inner">
												...
												<h3><Link to="/service-details">İş Danışmanlığı</Link></h3>
												<p>Lorem ipsum dolor sit amet conse
													ctetur adipisicing elit sed do eiusmod tempor incididunt ut labore et</p>
												<Link to="/service-details" className="service-two__link"><i className="fa fa-long-arrow-alt-right" /></Link>
												{/* /.service-two__link */}
