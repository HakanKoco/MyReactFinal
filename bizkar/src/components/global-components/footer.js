				...
				<footer className="site-footer-one">
							...
							<div className="row">
								...
								<div className="col-lg-4">
									<div className="footer-widget footer-widget__contact">
										<h3 className="footer-widget__title">Resmi Adres</h3>{/* /.footer-widget__title */}
										<div className="footer-widget__contact-box">
											...
											<p>205, Khola Sokak Adı, New York, ABD</p>
					...
					<div className="site-footer-one__bottom">
						<div className="container">
							...
							<p>Copy@2022 <a href="#">Bizkar</a>. Tüm Hakları Saklıdır. Tasarım LayerDrops tarafından yapılmıştır.</p>
						</div>{/* /.container */}
